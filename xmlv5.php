...
$conn->query("CREATE TABLE sigi_programa_estudios (
...
$conn->query("CREATE TABLE sigi_planes_estudio (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
$conn->query("CREATE TABLE sigi_modulo_formativo (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
$conn->query("CREATE TABLE sigi_semestre (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
$conn->query("CREATE TABLE sigi_unidad_didactica (
    id INT AUTO_INCREMENT PRIMARY KEY,
